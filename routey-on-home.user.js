...
// @description    Take back your BYU Home Page; bring those Route Y links back to their proper place.
// @match          http://home.byu.edu/home/
// @match          https://home.byu.edu/home/
// ==/UserScript==
...
(function(callback) {
  ...
  document.body.appendChild(script);
    ...
    /*
     * This extracts the links from the tree in MyBYU. I want to try to do this automatically but can't get around the authentication in MyBYU.
var menus = {};
$('#launcherTree').children('li').each(function(i, el) {
    var $li = $(el);
    var name = $li.children('.folder').text();
    menus[name] = $li.find('ul>li>.file>a').map(function(i, el) {
        var $link = $(el);
